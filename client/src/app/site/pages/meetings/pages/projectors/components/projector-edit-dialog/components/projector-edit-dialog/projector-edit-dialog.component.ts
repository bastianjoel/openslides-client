...
export class ProjectorEditDialogComponent extends BaseUiComponent implements OnInit {
    ...
    /**
     * Takes note of changes in a specific ViewModel's default-projector and toggles the corresponding checkbox
     * in the `Projector defaults`-selector if neccessary
